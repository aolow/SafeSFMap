# SafeSF Path Finder Proposal  - Exploratory Analysis and Visualization
# by A. Olow
...
# Increase in crime over time per districts
...
# Simple prediction total pedestrian-endangering crimes per neighborhood for 2015
...
# MIDDLE PANEL - total crimes per type per district
